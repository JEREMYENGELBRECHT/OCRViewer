...
{
    unsafe public class RGBImage : ImageBase
    {
            ...
            {                
                ...
                byte* src = (byte*)bitmapData.Scan0.ToPointer();
                {
                    ...
                    switch (bytenum)
                    {
                        case 0: // 1bppIndexed
                            throw new System.Exception(
                                string.Format("\n\nSorry! Pixel Format is {0}! The current version does not support...!\n\n", pxFormat.ToString()));
                            break;
                        case 1:
                        ...
                        default:
                            throw new System.Exception(
                                string.Format("Sorry! Image Format is {0}! The current version does not support...!", pxFormat.ToString()));
                            break;
                    }
                }
            }
